...
const (
	addPodNameLabelAnnotation = "does.not.matter/add-pod-name-label"
	podNameLabel              = "does.not.matter/pod-name"
)
...
func (r *PodReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if labelShouldBePresent == labelIsPresent {
		...
		log.Info("no update required for pod " + pod.Name)
		return ctrl.Result{}, nil
	}
